...
# Process NetCDF file
filename = "20250607_3H_MEDIAN.nc"
...
for i, time_step in enumerate(ds.time):
    try:
        ...
        legend_elements.append(Patch(facecolor='none', edgecolor='black', linewidth=0.5, label='Provinces boundaries'))
        ...
        legend_elements.append(Patch(facecolor='none', edgecolor='none', label='Data: WMO BarcelonaDustRegionalCenter & SDSWAS)'))
