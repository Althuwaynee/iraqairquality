...
try:
    ...
    for month in range(1, 13):     #for month in range(1, 13):
        MONTH = f"{month:02d}"  # Format as two-digit string
        ...
        logger.info(f"Processing complete for {YEAR}-{MONTH}")

    logger.info("Processing complete for all 2023 data")
