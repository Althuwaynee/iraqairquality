...
input_folders = [f for f in os.listdir(PARENT_DIR) if f.startswith('IRQ_20') and os.path.isdir(os.path.join(PARENT_DIR, f))]

if not input_folders:
    logger.error(f"No IRQ_20* folders found in directory: {PARENT_DIR}")
    sys.exit(1)
